...
execute if data storage temp {str:'{"text":"lighting II","color":"gray","italic":false}'} run scoreboard players set del tmp 1
execute if data storage temp {str:'{"text":"lighting I","color":"gray","italic":false}'} run scoreboard players set del tmp 1
